...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    ...
    ap.add_argument("--members-file", default="import/members.csv", help="CSV file of member emails")
    ap.add_argument("--admin-file", default="import/admin.csv", help="CSV file of admin emails")
    ap.add_argument("--view-file", default="import/view_only.csv", help="CSV file of view-only emails")
    ap.add_argument("--huntareas-file", default="import/huntareas.csv", help="CSV file of hunt area IDs")
